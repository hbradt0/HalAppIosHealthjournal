...
{
	public partial class EditFoodJournalScreen : UIViewController
	{
        ...
        HomeScreen2 hellouniversescreen; //MAY NEED TO BE COMMENTED OUT
        ...
        public EditFoodJournalScreen() : base ("EditJournalScreen", null)
	{
        ...
        private void ButtonDeleteClick(object sender, EventArgs eventArgs)
        {
            ...
            Confirm.Clicked += (object senders, UIButtonEventArgs es) =>
            {
                ...
                else
                {
                    ...
                    booktextView.Text = EmailFileRead.ReadText(EmailFileRead.fileName2);
                    if (this.hellouniversescreen == null) { this.hellouniversescreen = new HomeScreen2(); }
